...
int main()
{
    ...
    isiDataNilaiMhs(0,"1900676","Tiara Humaira",64.75);
    isiDataNilaiMhs(1,"1901321","Rival Swandy Irawan",76.11);
    isiDataNilaiMhs(2,"1902120","Agil Nopiantri",84.63);
    isiDataNilaiMhs(3,"1904341","Nandiaz Alifta Septiandi",77.07);
    isiDataNilaiMhs(4,"1904397","Ghirah Madani",66.70);
    
    strcpy(nim_cari, "1902120");
    ketemu=0;
    i=0;
